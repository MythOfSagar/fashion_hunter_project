...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    console.log(cartArrayData.length)
  }, [])
          ...
          <div id="right-lower">
            ...
            <div className="icon" onClick={handleLogin}>
              ...
              <Box className="icon-div" position="relative" >
                ...
                {
                  getLocalData("token") ? <Box className="manoj" position="absolute" left="22px" top="-2px" color="#ffffff" backgroundColor="#ff6161" width="23px" height="25px" fontWeight="700" borderRadius="50%" fontSize="18px" border="1px solid #ffffff" >{cartArrayData.length}</Box> : null
                }
