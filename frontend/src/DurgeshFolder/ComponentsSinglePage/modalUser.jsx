...
function Modaluser({data}) {
    ...
    return (
      <Box>
        <Box position="absolute" left={{base:"180px", sm: "242px", md: "242px", lg: "242px" ,xl: "236px",'2xl': "240px",}} top={{base:"8px", sm: "15px", md: "15px", lg: "15px" ,xl: "15px",'2xl': "15px",}}  fontSize="24px" fontWeight={800} color="red"  cursor="pointer">
